<?php
  ...
  * Slug: patterns-kit/sidebar-2
  * Categories: patterns-kit, patterns-kit-sidebar
  * Keywords: sidebar, search, category
  */
?>
...
<h3 class="alignwide has-foreground-color has-text-color has-content-heading-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px">Category</h3>
<!-- /wp:heading -->
